...
urlpatterns = [
    ...
    path('ajax/create_blank_guestlog_entry/', CreateBlankGuestLogEntry.as_view(),
         name='ajax-create-blank-guestlog-entry'),
    path('ajax/update_guestlog_entry/', UpdateGuestlogEntry.as_view(), name='ajax-update-guestlog-entry'),
    path('ajax/checkout_guestlog_entry/', CheckoutGuestlogEntry.as_view(), name='ajax-checkout-guestlog-entry'),
    path('ajax/filter_guestlog_entries/', FilterGuestlogEntries.as_view(), name='ajax-filter-guestlog-entries'),
